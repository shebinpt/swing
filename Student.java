...
frame.getContentPane().setBackground(UIManager.getColor("ToolBar.darkShadow"));
...
lblFirstname.setFont(new Font("Tahoma", Font.ITALIC, 20));
...
lblSurname.setFont(new Font("Tahoma", Font.ITALIC, 20));
...
lblCourseCode.setFont(new Font("Tahoma", Font.ITALIC, 20));
